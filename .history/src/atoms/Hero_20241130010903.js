  ...
  return (
    <div className="hero-section">
      ...
      <div className="hero-content">
        ...
        <p className="hero-heading">Empowering Africa to solve its toughest challenges with Artificial Intelligence<span>        <TypeAnimation
      sequence={[
        // Same substring at the start will only be typed out once, initially
        '_commerical organisations',
        1000, // wait 1s before replacing "Mice" with "Hamsters"
        '_national security organisations',
        1000,
        '_national security organisations',
        1000,
        '_commerical organisations',
