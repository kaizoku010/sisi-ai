...
<div className='solution-grid'>
    ...
    <Collapse
      ...
      items={[{ key: '1', label: 'Sisi Sentry is a ready-to-costomize AI solution tailored to the defense and intelligence demands unique to Africa. Designed with critical security organizations at its core, Sisi Sentry empowers
