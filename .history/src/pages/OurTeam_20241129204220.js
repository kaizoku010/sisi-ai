...
const oil = "
John is a results-driven Chemical Engineer with over 5 years of experience in the oil & gas and water supply industries. Holding a Bachelor of Science in Chemical Engineering from
Kyambogo University, he is passionate about deploying cutting-edge technologies, especially AI, to drive innovation in the energy and natural resource sectors. At Sisi AI, John focuses on
integrating AI solutions to enhance pipeline integrity, operations, and maintenance in the oil and gas industry. He has extensive experience in designing and executing drilling and completion fluid programs, including his current work on the Tilenga Oil Field project. Previously, he helped establish a petroleum quality testing lab at Nile Energy Limited and designed water systems for the Lutheran World Federation in Palorinya,"
const teamMembers = [
  {
    id: 1,
    name: "MJ Ssendagirwa",
