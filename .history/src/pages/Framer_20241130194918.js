...
<div className='solution-grid'>
    ...
    <Collapse
      ...
      items={[{ key: '1', label: 'Sisi Sentry is a ready-to-costomize AI solution tailored to the defense and intelligence demands unique to Africa. Designed with critical security organizations at its core, Sisi Sentry empowers teams to stay ahead of evolving threats. It harnesses AI to analyze and extract mission-critical insights, deploys predictive models to give operators a decisive edge, and provides continuous, scalable monitoring of sensitive assets for threat detection and prevention',         children: <div>
        <li>
          <ul>
