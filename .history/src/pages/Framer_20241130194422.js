...
<div className='solution-grid'>
    ...
    <Collapse
      items={[{ key: '1', label: 'Sisi Insight transforms how organizations manage and utilize data. By securely integrating
internal and web sources, it reorganizes and reclassifies data to uncover insights and
