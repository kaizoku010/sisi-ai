...
<div className="overlay-hts ">
    ...
    <div className="left-box">
        ...
        <p className="box-desc">Innovation is at the heart of our business. We’re using the latest advances in data science and engineering and putting them to work in the real world. Reach out </p>
