...
const ctoAbout = "Dr. Stephen M. Akandwanaho is a distinguished computer scientist with a PhD in Computer Science specialising in Artificial Intelligence. He possesses over ten years of deep expertise in
AI model development, machine learning, evolutionary algorithms, and hyper-heuristics. In 2023, he was recognised with a professorship from the University of North-West, South Africa,
reflecting his outstanding contributions in AI, advanced algorithms, and academic leadership. Dr. Akandwanaho’s research spans neural networks, combinatorial optimisation, and
cyber-defence mechanisms, with an advanced technical skillset in developing and deploying large-scale AI applications. His technical expertise includes proficiency in machine learning
frameworks like TensorFlow, PyTorch, and Keras, alongside extensive experience in Python, R, and Java for AI model programming. Dr. Akandwanaho is adept in designing and training deep
neural networks for complex predictive analytics, natural language processing, and autonomous systems. Dr. Akandwanaho has led initiatives in AI-driven decision-making and data intelligence
solutions. His work in integrating AI within secure, scalable architectures demonstrates his expertise in aligning technology with robust data governance and ethical AI practices, making
