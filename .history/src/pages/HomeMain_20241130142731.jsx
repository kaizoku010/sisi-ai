...
<div className="overlay-hts ">
    ...
    <div className="left-box">
        ...
        <p className="box-desc">Innovation is at the heart of our business. We’re using the latest advances in data science and engineering and putting them to work in the real world.

Join our world-class team in central London and help us in solving our customers most complex data challenges</p>
    </div>
</div>
</div>
        </section>
